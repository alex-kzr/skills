...
| Hermes running inside Docker needs to change its own container config | `references/docker-container-self-recreate.md` |
| Voice/STT transcription pipeline debugging | `references/stt-debugging-pipeline.md` |
