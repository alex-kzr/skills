...
description: Ground answers and documents in cited, verifiable sources. Use when research, comparisons, news summaries, fact-finding, or deliverables rely on externally retrieved information and need traceable citations.
---
...
uv run "$S" reset                                  # start a clean ledger
