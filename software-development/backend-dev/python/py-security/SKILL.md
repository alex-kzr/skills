---
name: py-security
description: Find and remediate Python security vulnerabilities. Use for Python security reviews, Bandit or Ruff security findings, secret handling, SQL injection prevention, unsafe deserialization, cryptography, TLS, and shell-injection risks.
---
...
Use the repository's approved dependency and tool configuration. Do not create agent-specific
permission files as part of a security review.
...
Use the repository's approved CI or pre-commit configuration for secret detection. Do not edit
`.git/hooks` directly: hooks are local, untracked, and can be bypassed.
