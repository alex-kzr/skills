---
name: python-pro
description: Implement broad Python 3.11+ application features when no focused Python skill better fits. Use for general module and service implementation; use the catalog's focused skills for testing, typing, async, packaging, performance, resilience, observability, or framework-specific work.
---
...
5. **Validate** — Run the repository's configured type checker and Ruff
...
- Follow the repository's configured formatter and lint rules
