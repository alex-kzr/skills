...
# Cleanup
deactivate
# Remove the explicitly-created test environment only after confirming its path.
# Example: verify it is a project-local directory named test-env, then remove it
# with the platform-appropriate safe command.
```
