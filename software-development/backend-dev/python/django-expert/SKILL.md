---
name: django-expert
description: Build or review Django and Django REST Framework applications. Use for Django models, migrations, ORM query optimization, serializers, viewsets, permissions, authentication, admin customization, and Django-specific tests.
---
