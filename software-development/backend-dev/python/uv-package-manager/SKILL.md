...
Install uv through a vetted, platform-native package manager or the organization-approved
bootstrap process. Do not pipe a remote installer directly into a shell. Confirm the installed
version with `uv --version` before using it.
