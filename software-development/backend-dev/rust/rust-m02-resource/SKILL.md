...
"Should I use Arc or Rc?"
    ...
    ↑ Check: rust-m07-concurrency (thread model)
    ↑ Check: domain-* (performance constraints)
```

| Situation | Trace To | Question |
|-----------|----------|----------|
| Rc vs Arc confusion | [rust-m07-concurrency](../rust-m07-concurrency/SKILL.md) | What's the concurrency model? |
| RefCell panics | [rust-m03-mutability](../rust-m03-mutability/SKILL.md) | Is interior mutability right here? |
| Memory leaks | [rust-m12-lifecycle](../rust-m12-lifecycle/SKILL.md) | Where should cleanup happen? |
...
| Interior mutability details | [rust-m03-mutability](../rust-m03-mutability/SKILL.md) |
| Multi-thread context | [rust-m07-concurrency](../rust-m07-concurrency/SKILL.md) |
| Resource lifecycle | [rust-m12-lifecycle](../rust-m12-lifecycle/SKILL.md) |
