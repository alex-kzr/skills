...
"How should I handle payment failures?"
    ...
    ↑ Check: rust-domain-fintech (transaction requirements)
...
```
"Need typed errors"
    ↓ rust-m06-error-handling: thiserror for library
    ↓ rust-m04-zero-cost: Error enum design

"Need error context"
    ↓ rust-m06-error-handling: anyhow::Context
    ↓ Logging: tracing with fields

"Need retry logic"
    ↓ rust-m07-concurrency: async retry patterns
...
| When | See |
|------|-----|
| Error handling basics | [rust-m06-error-handling](../rust-m06-error-handling/SKILL.md) |
| Retry implementation | [rust-m07-concurrency](../rust-m07-concurrency/SKILL.md) |
