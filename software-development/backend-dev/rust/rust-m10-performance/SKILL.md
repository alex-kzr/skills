...
"Need to reduce allocations"
    ↓ rust-m01-ownership: Use references, avoid clone
    ↓ rust-m02-resource: Pre-allocate with_capacity

"Need to parallelize"
    ↓ rust-m07-concurrency: Choose rayon or threads
    ↓ rust-m07-concurrency: Consider async for I/O-bound
...
| When | See |
|------|-----|
| Reducing clones | [rust-m01-ownership](../rust-m01-ownership/SKILL.md) |
| Concurrency options | [rust-m07-concurrency](../rust-m07-concurrency/SKILL.md) |
