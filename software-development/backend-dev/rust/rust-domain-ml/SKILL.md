...
"Need efficient data pipelines"
    ↓ rust-m10-performance: Streaming, batching
    ↓ polars: Lazy evaluation

"Need GPU inference"
    ↓ rust-m07-concurrency: Async data loading
    ↓ candle/tch-rs: CUDA backend

"Need model loading"
    ↓ rust-m12-lifecycle: Lazy init, caching
    ↓ tract: ONNX runtime
```
...
| Lazy initialization | [rust-m12-lifecycle](../rust-m12-lifecycle/SKILL.md) |
| Async patterns | [rust-m07-concurrency](../rust-m07-concurrency/SKILL.md) |
| Memory efficiency | [rust-m01-ownership](../rust-m01-ownership/SKILL.md) |
