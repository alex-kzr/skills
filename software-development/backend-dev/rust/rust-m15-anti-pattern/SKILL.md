...
"Why does my code have so many clones?"
    ...
    ↑ Check: rust-m09-domain (data flow design)
    ↑ Check: rust-m01-ownership (reference patterns)
```

| Anti-Pattern | Trace To | Question |
|--------------|----------|----------|
| Clone everywhere | [rust-m01-ownership](../rust-m01-ownership/SKILL.md) | Who should own this data? |
| Unwrap everywhere | [rust-m06-error-handling](../rust-m06-error-handling/SKILL.md) | What's the error strategy? |
| Rc everywhere | [rust-m09-domain](../rust-m09-domain/SKILL.md) | Is ownership clear? |
| Fighting lifetimes | [rust-m09-domain](../rust-m09-domain/SKILL.md) | Should data structure change? |
...
"Replace clone with proper ownership"
    ↓ rust-m01-ownership: Reference patterns
    ↓ rust-m02-resource: Smart pointer if needed

"Replace unwrap with proper handling"
    ↓ rust-m06-error-handling: ? operator
    ↓ rust-m06-error-handling: expect with message
```
...
| When | See |
|------|-----|
| Ownership patterns | [rust-m01-ownership](../rust-m01-ownership/SKILL.md) |
| Error handling | [rust-m06-error-handling](../rust-m06-error-handling/SKILL.md) |
| Mental models | [rust-m14-mental-model](../rust-m14-mental-model/SKILL.md) |
| Performance | [rust-m10-performance](../rust-m10-performance/SKILL.md) |
