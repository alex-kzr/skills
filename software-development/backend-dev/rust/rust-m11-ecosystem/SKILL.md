...
"Which HTTP framework should I use?"
    ...
    ↑ Check: rust-domain-web (latency, throughput needs)
...
"Integrate external crate"
    ↓ rust-m04-zero-cost: Trait bounds and generics
    ↓ rust-m06-error-handling: Error type compatibility

"FFI integration"
    ↓ rust-unsafe-checker: Safety requirements
    ↓ rust-m12-lifecycle: Resource cleanup
```
...
| When | See |
|------|-----|
| Error type design | [rust-m06-error-handling](../rust-m06-error-handling/SKILL.md) |
| Trait integration | [rust-m04-zero-cost](../rust-m04-zero-cost/SKILL.md) |
| FFI safety | [rust-unsafe-checker](../rust-unsafe-checker/SKILL.md) |
| Resource management | [rust-m12-lifecycle](../rust-m12-lifecycle/SKILL.md) |
