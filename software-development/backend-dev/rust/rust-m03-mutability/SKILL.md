...
E0499/E0502 (borrow conflicts)
    ...
    ↑ Check: rust-m09-domain (should data be split?)
    ↑ Check: rust-m07-concurrency (is async involved?)
```

| Persistent Error | Trace To | Question |
|-----------------|----------|----------|
| Repeated borrow conflicts | [rust-m09-domain](../rust-m09-domain/SKILL.md) | Should data be restructured? |
| RefCell in async | [rust-m07-concurrency](../rust-m07-concurrency/SKILL.md) | Is Send/Sync needed? |
| Mutex deadlocks | [rust-m07-concurrency](../rust-m07-concurrency/SKILL.md) | Is the lock design right? |
...
| Thread safety | [rust-m07-concurrency](../rust-m07-concurrency/SKILL.md) |
| Data structure design | [rust-m09-domain](../rust-m09-domain/SKILL.md) |
