...
E0277 (trait bound not satisfied)
    ...
    ↑ Check: rust-m09-domain (what behavior is being abstracted?)
    ↑ Check: rust-m05-type-driven (should use newtype?)
```

| Persistent Error | Trace To | Question |
|-----------------|----------|----------|
| Complex trait bounds | [rust-m09-domain](../rust-m09-domain/SKILL.md) | Is the abstraction right? |
| Object safety issues | [rust-m05-type-driven](../rust-m05-type-driven/SKILL.md) | Can typestate help? |
| Type explosion | [rust-m10-performance](../rust-m10-performance/SKILL.md) | Accept dyn overhead? |
...
| When | See |
|------|-----|
| Type-driven design | [rust-m05-type-driven](../rust-m05-type-driven/SKILL.md) |
| Domain abstraction | [rust-m09-domain](../rust-m09-domain/SKILL.md) |
| Performance concerns | [rust-m10-performance](../rust-m10-performance/SKILL.md) |
| Send/Sync bounds | [rust-m07-concurrency](../rust-m07-concurrency/SKILL.md) |
