...
|-----------------|-------------------|----------------|
| Web API, HTTP, axum, actix, handler | [rust-domain-web](../rust-domain-web/SKILL.md) | Handlers run on any thread |
| 交易, 支付, trading, payment | [rust-domain-fintech](../rust-domain-fintech/SKILL.md) | Audit + thread safety |
| gRPC, kubernetes, microservice | [rust-domain-cloud-native](../rust-domain-cloud-native/SKILL.md) | Distributed tracing |
| CLI, terminal, clap | [rust-domain-cli](../rust-domain-cli/SKILL.md) | Usually single-thread OK |

### Example: Web API + Rc Error

```
"Rc cannot be sent between threads" in Web API context
    ↑ DETECT: "Web API" → Load rust-domain-web
    ↑ FIND: rust-domain-web says "Shared state must be thread-safe"
    ↑ FIND: rust-domain-web says "Rc in state" is Common Mistake
...
"Send not satisfied for my type"
    ...
    ↑ Check: rust-m09-domain (is the data model correct?)
```

| Situation | Trace To | Question |
|-----------|----------|----------|
| Send/Sync in Web | [rust-domain-web](../rust-domain-web/SKILL.md) | What's the state management pattern? |
| Send/Sync in CLI | [rust-domain-cli](../rust-domain-cli/SKILL.md) | Is multi-thread really needed? |
| Mutex vs channels | [rust-m09-domain](../rust-m09-domain/SKILL.md) | Shared state or message passing? |
| Async vs threads | [rust-m10-performance](../rust-m10-performance/SKILL.md) | What's the workload profile? |
...
| When | See |
|------|-----|
| Smart pointer choice | [rust-m02-resource](../rust-m02-resource/SKILL.md) |
| Interior mutability | [rust-m03-mutability](../rust-m03-mutability/SKILL.md) |
| Performance tuning | [rust-m10-performance](../rust-m10-performance/SKILL.md) |
