...
"Need to validate email format"
    ...
    ↑ Check: rust-m09-domain (Email as Value Object)
    ↑ Check: domain-* (validation requirements)
```

| Situation | Trace To | Question |
|-----------|----------|----------|
| What types to create | [rust-m09-domain](../rust-m09-domain/SKILL.md) | What's the domain model? |
| State machine design | [rust-m09-domain](../rust-m09-domain/SKILL.md) | What are valid transitions? |
| Marker trait usage | [rust-m04-zero-cost](../rust-m04-zero-cost/SKILL.md) | Static or dynamic dispatch? |
...
| When | See |
|------|-----|
| Domain modeling | [rust-m09-domain](../rust-m09-domain/SKILL.md) |
| Trait design | [rust-m04-zero-cost](../rust-m04-zero-cost/SKILL.md) |
| Error handling in constructors | [rust-m06-error-handling](../rust-m06-error-handling/SKILL.md) |
