...
"How should I model a Transaction?"
    ...
    ↑ Check: rust-domain-fintech (audit, precision requirements)
...
```
"Model as Entity"
    ↓ rust-m01-ownership: Owned, unique
    ↓ rust-m05-type-driven: Newtype for Id

"Model as Value Object"
    ↓ rust-m01-ownership: Clone/Copy OK
    ↓ rust-m05-type-driven: Validate at construction

"Model as Aggregate"
    ↓ rust-m01-ownership: Parent owns children
    ↓ rust-m02-resource: Consider Rc for shared within aggregate
```
...
| When | See |
|------|-----|
| Type-driven implementation | [rust-m05-type-driven](../rust-m05-type-driven/SKILL.md) |
| Ownership for aggregates | [rust-m01-ownership](../rust-m01-ownership/SKILL.md) |
| Domain error handling | [rust-m13-domain-error](../rust-m13-domain-error/SKILL.md) |
