...
"Need shared application state"
    ↓ rust-m07-concurrency: Use Arc for thread-safe sharing
    ↓ rust-m02-resource: Arc<RwLock<T>> for mutable state

"Need request validation"
    ↓ rust-m05-type-driven: Validated extractors
    ↓ rust-m06-error-handling: IntoResponse for errors

"Need middleware stack"
    ↓ rust-m12-lifecycle: Tower layers
    ↓ rust-m04-zero-cost: Trait-based composition
```
...
| When | See |
|------|-----|
| Async patterns | [rust-m07-concurrency](../rust-m07-concurrency/SKILL.md) |
| State management | [rust-m02-resource](../rust-m02-resource/SKILL.md) |
| Error handling | [rust-m06-error-handling](../rust-m06-error-handling/SKILL.md) |
| Middleware design | [rust-m12-lifecycle](../rust-m12-lifecycle/SKILL.md) |
