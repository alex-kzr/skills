...
"Why can't I do X in Rust?"
    ...
    ↑ Check: rust-m01-ownership through rust-m07-concurrency for the rule being enforced
...
"I understand the concept, now how do I implement?"
    ↓ rust-m01-ownership: Ownership patterns
    ↓ rust-m02-resource: Smart pointer choice
    ↓ rust-m07-concurrency: Thread safety
```
...
| Stage | Focus | Skills |
|-------|-------|--------|
| Beginner | Ownership basics | [rust-m01-ownership](../rust-m01-ownership/SKILL.md), [rust-m14-mental-model](../rust-m14-mental-model/SKILL.md) |
| Intermediate | Smart pointers, error handling | rust-m02-resource, rust-m06-error-handling |
| Advanced | Concurrency, unsafe | [rust-m07-concurrency](../rust-m07-concurrency/SKILL.md), [rust-unsafe-checker](../rust-unsafe-checker/SKILL.md) |
| Expert | Design patterns | rust-m09-domain through rust-m15-anti-pattern, domain-* |
...
| When | See |
|------|-----|
| Ownership errors | [rust-m01-ownership](../rust-m01-ownership/SKILL.md) |
| Smart pointers | [rust-m02-resource](../rust-m02-resource/SKILL.md) |
| Concurrency | [rust-m07-concurrency](../rust-m07-concurrency/SKILL.md) |
| Anti-patterns | [rust-m15-anti-pattern](../rust-m15-anti-pattern/SKILL.md) |
