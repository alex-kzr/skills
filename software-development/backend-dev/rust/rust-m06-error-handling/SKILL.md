...
"Should I return Result or Option?"
    ...
    ↑ Check: rust-m09-domain (what does domain say?)
    ↑ Check: domain-* (error handling requirements)
```

| Situation | Trace To | Question |
|-----------|----------|----------|
| Too many unwraps | [rust-m09-domain](../rust-m09-domain/SKILL.md) | Is the data model right? |
| Error context design | [rust-m13-domain-error](../rust-m13-domain-error/SKILL.md) | What recovery is needed? |
| Library vs app errors | [rust-m11-ecosystem](../rust-m11-ecosystem/SKILL.md) | Who are the consumers? |
...
| When | See |
|------|-----|
| Domain error strategy | [rust-m13-domain-error](../rust-m13-domain-error/SKILL.md) |
| Crate boundaries | [rust-m11-ecosystem](../rust-m11-ecosystem/SKILL.md) |
| Type-safe errors | [rust-m05-type-driven](../rust-m05-type-driven/SKILL.md) |
