...
"Need offline-first design"
    ↓ rust-m12-lifecycle: Local buffer with persistence
    ↓ rust-m13-domain-error: Retry with backoff

"Need power efficiency"
    ↓ rust-domain-embedded: no_std patterns
    ↓ rust-m10-performance: Minimal allocations

"Need reliable messaging"
    ↓ rust-m07-concurrency: Async with timeout
    ↓ MQTT: QoS levels
```
...
| When | See |
|------|-----|
| Embedded patterns | [rust-domain-embedded](../rust-domain-embedded/SKILL.md) |
| Async patterns | [rust-m07-concurrency](../rust-m07-concurrency/SKILL.md) |
| Error recovery | [rust-m13-domain-error](../rust-m13-domain-error/SKILL.md) |
