...
metadata:
  ...
  source: https://github.com/BeforeMerge/beforemerge-skills/tree/main/skills/nextjs-review
---
...
Read individual rule files in [`nextjs-review/rules/`](nextjs-review/rules/) for detailed explanations and code examples.
...
For the complete compiled guide: [`AGENTS.md`](nextjs-review/AGENTS.md)
