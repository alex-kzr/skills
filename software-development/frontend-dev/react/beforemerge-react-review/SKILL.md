...
metadata:
  ...
  source: https://github.com/BeforeMerge/beforemerge-skills/tree/main/skills/react-review
---
...
Read individual rule files in [`react-review/rules/`](react-review/rules/) for detailed explanations and code examples.
...
For the complete compiled guide: [`AGENTS.md`](react-review/AGENTS.md)
