...
| Skill | [github-issue-to-pr/](github-issue-to-pr/SKILL.md) | Take a GitHub issue through implementation to a verified pull request. | Open when resolving an issue and preparing its pull request. |
