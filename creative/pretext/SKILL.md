---
name: pretext
description: Build creative browser demos with DOM-free text layout. Use when creating text-driven generative art, kinetic typography, text-flow layouts, or browser games built from measured text.
---
