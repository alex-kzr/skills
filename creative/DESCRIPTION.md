...
Creative content generation — ASCII art, hand-drawn style diagrams, visual design, music, animation, and generative media tools.
...
| Skill | [design-md/](design-md/SKILL.md) | Author/validate/export Google's DESIGN.md token spec files. | Open when working with design token specifications. |
| Skill | [excalidraw/](excalidraw/SKILL.md) | Hand-drawn Excalidraw JSON diagrams (arch, flow, seq). | Open when creating hand-drawn-style diagrams with Excalidraw. |
| Skill | [humanizer/](humanizer/SKILL.md) | Humanize text: strip AI-isms and add real voice. | Open when making AI-generated text sound more natural. |
