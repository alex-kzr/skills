...
- Node.js: `agents/runtime/node/node_modules`

Do not install dependencies inside this skill directory.

This skill's optional PyTorch hardware check requires the optional ML
runtime: `agents/runtime/python/ml/.venv`.
...
# Real-time progress via WebSocket (optional `websocket-client`, provided by the shared agents runtime)
python3 scripts/run_workflow.py \
