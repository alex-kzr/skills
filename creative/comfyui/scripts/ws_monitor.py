...
Requires: websocket-client, provided by the shared agents runtime
(agents/runtime/python/base/.venv). Falls back to a clear error message
when not available.
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(json.dumps({
            ...
            "hint": "Prepare agents/runtime/python/base/.venv (see runtime/README.md)",
        }))
        return 1
