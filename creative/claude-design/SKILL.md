...
## Sketch Mode: Rapid Design Variants

Quickly generate 2-3 throwaway HTML mockups to compare design directions before committing to a full design. Use for brainstorming layout options, color schemes, or component arrangements.

### When to Use

- User wants to compare design options
- Exploring different visual directions before committing
- Rapid prototyping with throwaway artifacts

### Approach

1. Generate 2-3 distinct HTML variants (different layouts, color palettes, or typography)
2. Each variant is self-contained HTML with embedded CSS
3. Keep them simple — the goal is comparison, not polish
4. Present options side by side or as separate files

---

## Pretext Mode: DOM-free Text Layout Demos

Build creative browser demos using [@chenglou/pretext](https://github.com/chenglou/pretext) — a DOM-free text layout engine for artistic/creative browser experiences.

### When to Use

- User wants creative/artsy browser demos
- Non-standard text layouts (orbits, flows, custom paths)
- Experimental typography and visual effects

### Templates

- `templates/pretext/donut-orbit.html` — circular text orbit demo
- `templates/pretext/hello-orb-flow.html` — flowing orb text demo

### Reference

- `references/pretext/patterns.md` — pretext layout patterns and API reference
