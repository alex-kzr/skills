...
|---|---|---|---|
| Skill | [task-router/](task-router/SKILL.md) | Routing table: determines which approach and tools to use based on task type. | Open when routing a task to the appropriate tool or workflow. |
